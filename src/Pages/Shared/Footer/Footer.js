...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 text-white bg-base-200">
                <div>
            ...
            <footer className="footer px-10 w-full py-4 border-t bg-base-500 text-white border-base-500">
                <div className="items-center grid-flow-col">
                    <img src={logo} alt="logo"  className=' w-14'/>
                    <p>Coading Academy Ltd. <br />Copyright @ 2023</p>
                </div>
